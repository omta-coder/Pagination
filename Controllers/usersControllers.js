...
//register user
 exports.userpost = async(req,res) =>{
   ...
   if(!fname || !lname || !email || !gender || !mobile || !location || !status || !file){
   ...
   try {
    ...
    if(preuser){
        ...
        const userData = new users({
           fname,lname,email,mobile,location,gender,status,profile:file,datecreated
        });
        await userData.save();
...
exports.useredit = async(req,res)=>{
  ...
  try {
    const updateuser = await users.findByIdAndUpdate({_id:id},{
      fname,lname,email,mobile,location,gender,status,profile:file,dateUpdated
    },{
      new:true
    });
